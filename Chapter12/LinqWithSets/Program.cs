...
using System.Collections.Generic; // for Enumerable<T>
...
namespace LinqWithSets
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Output(cohort1.Zip(cohort2, (c1, c2) => $"{c1} mathced with {c2}"), "cohort1.Zip(cohort2, (c1, c2) => $\"{c1} mathced {c2}\")" + ": matches items based on position in the sequence");
        }
    }
}
