    ...
    class Program
    {
        ...
        static void WorkWithDrives()
        {
            ...
            foreach (DriveInfo drive in DriveInfo.GetDrives())
            {
                if (drive.IsReady)
                {
                    WriteLine($"| {drive.Name,-30} | {drive.DriveType,-10} | {drive.DriveFormat,-7} | {drive.TotalSize,19:N0} | {drive.AvailableFreeSpace,18:N0} |");
                }
                else
                {
        ...
        static void WorkingWithFiles()
        {
            ...
            textWriter.Close(); // close file and release resoures
            ...
            // read from the text file bacbkup
